	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				...
				<small class="form-text text-primary">Kompetensi yang dipilih peserta didik setelah masuk sekolah ini. (Khusus SMK)</small>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<select required name="jenis_pendaftaran" id="" class="form-control">
					<option value="">--</option>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="asal_sekolah" value="{{$data['asal_sekolah'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="nomor_peserta_ujian" value="{{$data['nomor_peserta_ujian'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="no_ijazah" value="{{$data['no_ijazah'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="no_skhu" value="{{$data['no_skhu'] ?? ""}}">
