<form action="{{ route('ppdb.edit.datadiri', $page) }}" method="POST">
	...
	<div class="card-body">
		<h4>Data pribadi peserta didik</h4>
		<div class="form-group row">
			<label for="" class="col-form-label col-md-3">1. Nama lengkap</label>
			<div class="col-md-9">
				<input type="text" class="form-control" required name="nama_lengkap" value="{{$data['nama_lengkap'] ?? $auth->name}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="jklaki" required name="jenis_kelamin" class="custom-control-input" value="l" @if (isset($data['jenis_kelamin']) && $data['jenis_kelamin'] == 'l') checked @endif>
					<label class="custom-control-label" for="jklaki">Laki-laki</label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="jkperempuan" name="jenis_kelamin" class="custom-control-input" value="p" @if (isset($data['jenis_kelamin']) && $data['jenis_kelamin'] == 'p') checked @endif>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="nomor_akta" value="{{$data['nomor_akta'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<select required name="agama" id="" class="form-control">
					<option value="">--</option>
					<option @if(isset($data['agama']) && $data['agama'] == 'islam') selected @endif value="islam">islam</option>
					<option @if(isset($data['agama']) && $data['agama'] == 'kristen') selected @endif value="kristen">Kristen/Protestan</option>
					<option @if(isset($data['agama']) && $data['agama'] == 'katholik') selected @endif value="katholik">Katholik</option>
					<option @if(isset($data['agama']) && $data['agama'] == 'hindu') selected @endif value="hindu">Hindu</option>
					<option @if(isset($data['agama']) && $data['agama'] == 'budha') selected @endif value="budha">Budha</option>
				</select>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="kewarganegaraan" value="{{$data['kewarganegaraan'] ?? "Indonesia"}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[jalan]" value="{{$data['alamat']['jalan'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[rt]" value="{{$data['alamat']['rt'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[rw]" value="{{$data['alamat']['rw'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[kelurahan]" value="{{$data['alamat']['kelurahan'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[kecamatan]" value="{{$data['alamat']['kecamatan'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="alamat[kodepos]" value="{{$data['alamat']['kodepos'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<select required name="moda_transportasi" id="" class="form-control">
					<option value="">--</option>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" name="nomor_kks" placeholder="" value="{{$data['nomor_kks'] ?? ""}}">
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" required name="anak_keberapa" value="{{$data['anak_keberapa'] ?? ""}}">
				<small class="form-text text-primary">Cukup Jelas </small>
			</div>
		</div>
		<hr>
		<h4>Kartu Perlindungan Sosial (KPS)</h4>
		<div class="form-group row">
			<label for="" class="col-form-label col-md-3">24. Penerima KPS/PKH</label>
			<div class="col-md-9">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="penerima_kps_ya" required name="penerima_kps" class="custom-control-input" value="ya" @if (isset($data['penerima_kps']) && $data['penerima_kps'] == 'ya') checked @endif>
		...
		<hr>
		<h4>Program Indoensia Pintar (PIP)</h4>
		<div class="form-group row">
			<label for="" class="col-form-label col-md-3">26. Usulan dari sekolah (Layak PIP)</label>
			<div class="col-md-9">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="kip_ya" required name="usulan_kip_sekolah" class="custom-control-input" value="ya" @if(isset($data['usulan_kip_sekolah']) && $data['usulan_kip_sekolah'] == "ya") checked @endif>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="pnerima_kip_ya" required name="penerima_kip" class="custom-control-input" value="ya" @if(isset($data['penerima_kip']) && $data['penerima_kip'] == 'ya') checked @endif>
		...
		<div class="form-group row">
			...
			<div class="col-md-9">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="terima_fisik_kip_ya" required name="terima_fisik_kip" class="custom-control-input" value="ya" @if(isset($data['terima_fisik_kip']) && $data['terima_fisik_kip'] == 'ya') checked @endif>
