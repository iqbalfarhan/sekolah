			...
			<div class="col-md-6">
				...
				<table class="table table-sm mb-5">
					...
					<tr>
						<th>Kelas</th>
						<th>:</th>
						<td>{{$data->kelas->grade ?? "-"}} {{$data->kelas->jurusan->inisial ?? ""}} {{$data->kelas->kelompok ?? ""}}</td>
					</tr>
					<tr>
						<th>Jenis Kelamin</th>
						<th>:</th>
				...
				<table class="table table-sm mb-5">
					...
					<tr>
						<td>
							<b>Prestasi</b>
							<ol>
								@if (isset($rincian->prestasi) && $rincian->prestasi!= null)
					...
					<tr>
						<td>
							<b>Beasiswa</b>
							<ol>
								@if (isset($rincian->beasiswa) && $rincian->beasiswa!= null)
