...
<div class="card">
	...
	<form action="{{ route('student.edit.rincian') }}" method="POST">
		@csrf
		@method('PUT')
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" @if(isset($data['jarak_sekolah']) && $data['jarak_sekolah'] == "Kurang dari 1 Km") checked @endif id="jklaki" name="jarak_sekolah" class="custom-control-input" value="Kurang dari 1 Km">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<div class="input-group">
						<input type="text" name="jauh_sekolah" class="form-control" value="{{$data['jauh_sekolah'] ?? ""}}">
						<div class="input-group-append">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<div class="row">
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="waktu_tempuh[jam]" class="form-control" value="{{$data['waktu_tempuh']['jam'] ?? ""}}">
								<div class="input-group-append">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="waktu_tempuh[menit]" class="form-control" value="{{$data['waktu_tempuh']['menit'] ?? ""}}">
								<div class="input-group-append">
			...
			<div class="form-group row">
				...
				<div class="col-md-9 form-inline">
					<input type="text" name="jumlah_saudara" class="form-control" value="{{$data['jumlah_saudara'] ?? ""}}">
