...
<div class="card">
	...
	<form action="{{ route('student.edit.orangtua') }}" method="post">
		@csrf
		@method('PUT')
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" name="ayah[nama_lengkap]" value="{{$data['ayah']['nama_lengkap'] ?? ""}}">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" name="ayah[nik]" value="{{$data['ayah']['nik'] ?? ""}}">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" name="ayah[tahun_lahir]" value="{{$data['ayah']['tahun_lahir'] ?? ""}}">
			...
			<div class="form-group row">
				...
				<div class="col-md-9 form-inline">
					<select name="ayah[pendidikan]" id="" class="form-control">
						<option value="">--</option>
			...
			<div class="form-group row">
				...
				<div class="col-md-9 form-inline">
					<select name="ayah[pekerjaan]" id="" class="form-control">
						<option value="">--</option>
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<select name="ayah[penghasilan]" id="" class="form-control">
						<option value="">--</option>
			...
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">Berkebutuhan Khusus</label>
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" name="ibu[nama_lengkap]" value="{{$data['ibu']['nama_lengkap'] ?? ""}}">
					<small class="form-text text-primary">Nama yah kandung peserta didik sesuai dengan dokumen resmi yang berlaku. hindari penggunaan nama gelar akademik atau sosial (seperti Alm., Dr., Drs., S.Pd, dan H) </small>
				</div>
			</div>
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">NIK</label>
				<div class="col-md-9">
					<input type="text" class="form-control" name="ibu[nik]" value="{{$data['ibu']['nik'] ?? ""}}">
			...
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">Tahun Lahir</label>
				<div class="col-md-9">
					<input type="text" class="form-control" name="ibu[tahun_lahir]" value="{{$data['ibu']['tahun_lahir'] ?? ""}}">
			...
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">Pendidikan</label>
				<div class="col-md-9 form-inline">
					<select name="ibu[pendidikan]" id="" class="form-control">
						<option value="">--</option>
			...
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">Perkerjaan</label>
				<div class="col-md-9 form-inline">
					<select name="ibu[pekerjaan]" id="" class="form-control">
						<option value="">--</option>
			...
			<div class="form-group row">
				<label for="" class="col-form-label col-md-3">Penghasilan Bulanan</label>
				<div class="col-md-9">
					<select name="ibu[penghasilan]" id="" class="form-control">
						<option value="">--</option>
